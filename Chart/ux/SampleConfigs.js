  ...
  config : {
    ...
    splineCatShift : {
      ...
      chartConfig : {
        ...
        title : {
          text : 'Click Reload Data to see the lines are being shift, xAxis categories data. Warning: possible bug in Highcharts',
          x : -20 //center
        },
        subtitle : {
          text : 'Random Value',
      ...
      series : [{
        ...
        events: {
           click: function(evt) {
              ...
              Demo.menu.showAt(evt.pageX + 5, evt.pageY + 5);
           }
        },
        xField : 'time'
      }, {
